...
class Activity_Controller:
    def register(owner_email: str, owner_enroll: str, proof_doc: str, period:str, type:str, description:str):
        ...
        activity = Activity.register(owner_email, owner_enroll, proof_doc, period, type, description, ACTIVITY_STATUS_CREATED)
